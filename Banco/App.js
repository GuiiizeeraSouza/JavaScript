...
module.exports = class App {
    ...
    static transfer(fromUserEmail, toUserEmail, value) {
        ...
        const toUser = App.findUser(fromUserEmail)
        if(fromUser && toUser){
            const newTramsfer = new Transfer(fromUser, toUser, value)
            fromUser.account.addTransfer(newTramsfer)
            toUser.account.addTransfer(newTramsfer)
        }
